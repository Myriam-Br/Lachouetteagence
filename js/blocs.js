...
function addKeyBoardSupport() {
    ...
    $(window).on('keydown', e => {
        ...
        if ($(".close-lightbox").attr('aria-hidden') == 'false' && keyCode === 27) {
            $("#lightbox-modal").remove();
